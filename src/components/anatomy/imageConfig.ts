...
export const imageTransforms: Record<string, string> = {
  ...
  [`${imagePathFront}/deltoids.svg`]: 'translateX(8px)',
  [`${imagePathFront}/triceps-long-head.svg`]: 'translateX(8px)',
  [`${imagePathFront}/triceps-medial-head.svg`]: 'translateX(8px)',
  [`${imagePathFront}/biceps-brachii.svg`]: 'translateX(8px)',
  [`${imagePathFront}/brachialis.svg`]: 'translateX(8px)',
  [`${imagePathFront}/brachioradialis.svg`]: 'translateX(7.5px)',
  [`${imagePathFront}/extensor-carpi-radialis.svg`]: 'translateX(5.5px)',
  [`${imagePathFront}/flexor-carpi-radialis.svg`]: 'translateX(9px)',
