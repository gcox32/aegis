      ...
      <div className="gap-4 grid grid-cols-1 sm:grid-cols-2">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="bg-zinc-950/60 focus:bg-zinc-900/80 px-3 py-2 border border-zinc-800 focus:border-brand-primary rounded-lg outline-none ring-0 max-w-[98%] text-white text-sm transition-colors"
          />
        </div>
